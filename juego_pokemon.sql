...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-02-2019 a las 19:04:19
...
CREATE TABLE `personajes` (
  ...
  `color_pelo` varchar(30) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `personajes` (`id`, `nombre`, `nivel`, `fk_usuario`, `genero`, `raza`, `equipo`, `color_ojos`, `color_pelo`) VALUES
(1, 'poke_joshe', 1, 1, NULL, NULL, NULL, NULL, NULL),
(2, 'poke_david', 1, 2, NULL, NULL, NULL, NULL, NULL),
(3, 'joshe', 1, 4, '', '', '', '', ''),
(4, 'luisas', 1, 5, 'Hombr', 'Europ', 'Zaf', 'Marr', 'Cast'),
(5, 'cuare', 1, 3, 'Hombr', 'Moren', 'Zaf', 'Marr', 'Cast');
...
(4, NULL, 1, 3, 2, NULL, NULL),
(7, NULL, 1, 2, 2, NULL, NULL),
(8, NULL, 1, 1, 1, NULL, NULL),
(9, NULL, 1, 4, 2, NULL, NULL),
(15, NULL, 1, 3, 2, NULL, NULL),
(16, NULL, 1, 1, 2, NULL, NULL),
(17, NULL, 1, 2, 2, NULL, NULL),
(18, NULL, 1, 4, 1, 39, 1),
(19, NULL, 1, 2, 2, 60, 1),
(20, NULL, 1, 2, 2, 60, 1),
(21, NULL, 1, 16, 2, 40, 1),
...
INSERT INTO `pokemones` (`id`, `pokedex`, `name`, `hp`, `attack`, `defence`, `special_attack`, `special_defence`, `speed`, `total`, `type_1`, `type_2`, `imagen`, `descripcion`) VALUES
(1, '1', 'Bulbasaur', 45, 49, 49, 65, 65, 45, 318, 'Grass', 'Poison', 'https://vignette.wikia.nocookie.net/es.pokemon/images/4/43/Bulbasaur.png/revision/latest/scale-to-width-down/350?cb=20170120032346', ''),
(2, '2', 'Ivysaur', 60, 62, 63, 80, 80, 60, 405, 'Grass', 'Poison', 'https://vignette.wikia.nocookie.net/es.pokemon/images/5/56/Charmander.png/revision/latest?cb=20140207202456', ''),
(3, '3', 'Venusaur', 80, 82, 83, 100, 100, 80, 525, 'Grass', 'Poison', 'https://vignette.wikia.nocookie.net/es.pokemon/images/5/56/Charmander.png/revision/latest?cb=20140207202456', ''),
(4, '4', 'Charmander', 39, 52, 43, 60, 50, 65, 309, 'Fire', '', 'https://vignette.wikia.nocookie.net/es.pokemon/images/5/56/Charmander.png/revision/latest?cb=20140207202456', ''),
(5, '5', 'Charmeleon', 58, 64, 58, 80, 65, 80, 405, 'Fire', '', 'https://vignette.wikia.nocookie.net/es.pokemon/images/5/56/Charmander.png/revision/latest?cb=20140207202456', ''),
(6, '6', 'Charizard', 78, 84, 78, 109, 85, 100, 534, 'Fire', 'Flying', 'https://vignette.wikia.nocookie.net/es.pokemon/images/5/56/Charmander.png/revision/latest?cb=20140207202456', ''),
(7, '7', 'Squirtle', 44, 48, 65, 60, 54, 43, 314, 'Water', '', 'https://vignette.wikia.nocookie.net/es.pokemon/images/5/56/Charmander.png/revision/latest?cb=20140207202456', ''),
...
CREATE TABLE `pokemones_ataques` (
  `id` int(11) NOT NULL,
  `pok_per` int(11) DEFAULT NULL,
  `ataque_1` int(11) NOT NULL,
  `ataque_2` int(11) NOT NULL,
  `ataque_3` int(11) NOT NULL,
  `ataque_4` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(3, 'jose', '1234', NULL, '2019-02-19 12:43:35'),
...
--
-- Indices de la tabla `pokemones_ataques`
--
ALTER TABLE `pokemones_ataques`
  ADD PRIMARY KEY (`id`),
  ADD KEY `pok_per` (`pok_per`),
  ADD KEY `ataque_1` (`ataque_1`),
  ADD KEY `ataque_2` (`ataque_2`),
  ADD KEY `ataque_3` (`ataque_3`),
  ADD KEY `ataque_4` (`ataque_4`);
...
--
-- AUTO_INCREMENT de la tabla `pokemones_ataques`
--
ALTER TABLE `pokemones_ataques`
...
--
ALTER TABLE `nivel_ataques`
  ADD CONSTRAINT `pokemon` FOREIGN KEY (`pokemon`) REFERENCES `pokemones` (`id`);
...
--
ALTER TABLE `pokedexs`
  ADD CONSTRAINT `pokedexs_ibfk_1` FOREIGN KEY (`fk_pokemon`) REFERENCES `pokemones` (`id`),
...
--
ALTER TABLE `pokemones_ataques`
  ADD CONSTRAINT `ataque_1` FOREIGN KEY (`ataque_1`) REFERENCES `ataques` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `ataque_2` FOREIGN KEY (`ataque_2`) REFERENCES `ataques` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `ataque_3` FOREIGN KEY (`ataque_3`) REFERENCES `ataques` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `ataque_4` FOREIGN KEY (`ataque_4`) REFERENCES `ataques` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `pok_per` FOREIGN KEY (`pok_per`) REFERENCES `pokedexs` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
